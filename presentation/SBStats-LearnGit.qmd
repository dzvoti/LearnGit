...
If you experience Git credentials error in RStudio e.g.,

`error: could not find UI helper 'GitHub.UI'`

Chapter 9 of [this book](https://happygitwithr.com/https-pat.html#tldr) has detailed steps on resolving this by creating a token for authenticating your RStudio's access to your GitHub. I summarise these steps below:

-   `usethis::create_github_token()`
-   generate and copy a personal access token. 
